...
public class OperacionService {
        ...
        if (usuarioEcontrado != null){
            ...
            if (libroEncontrado != null){
                if (libroEncontrado.isDisponible()){
                    ...
                    Operaciones operacion = new Operaciones("Préstamo", libroEncontrado, usuarioEcontrado, LocalDate.now());
    ...
    public static Libro reversionOperaciones(BinarySearchTree <Usuario> usuarios, BinarySearchTree <Libro> libros, Stack <Operaciones> acciones){
        ...
        if (!acciones.isEmpty()){
            ...
            libroSaliente = libro;
            if (operacionReciente.getTipo().equalsIgnoreCase("Préstamo")){
                ...
                if (usuario.getLibrosPrestados() > 0){
                    ...
                    System.out.println("Préstamo revertido. El libro fue devuelto...");
